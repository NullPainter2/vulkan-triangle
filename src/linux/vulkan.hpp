...
namespace VK
{
	struct MyVulkan {
		...
		OsSpecificStuff osSpecificStuff;
...
#define vk_fun(name) PFN_##name name;
	...
	// vk_fun(vkCmdBindShadersEXT); // TODO:
...
#pragma endregion
	...
	{
		auto dll = dlopen(dllName, RTLD_NOW);
		assert(dll);
		void* result = dlsym(dll, procName);
		assert(result);
		return result;
	}
...
#pragma region "load vulkan libraries from dll"
		...
		vkCreateInstance = (PFN_vkCreateInstance)_LoadProcedure("libvulkan.so", "vkCreateInstance");
		vkGetInstanceProcAddr = (PFN_vkGetInstanceProcAddr)_LoadProcedure("libvulkan.so", "vkGetInstanceProcAddr");
		//vkCreateWin32SurfaceKHR = (PFN_vkCreateWin32SurfaceKHR)_LoadProcedure("libvulkan.so", "vkCreateWin32SurfaceKHR");
		vkCreateXlibSurfaceKHR = (PFN_vkCreateXlibSurfaceKHR) _LoadProcedure("libvulkan.so", "vkCreateXlibSurfaceKHR");
		vkEnumerateInstanceLayerProperties = (PFN_vkEnumerateInstanceLayerProperties)_LoadProcedure("libvulkan.so", "vkEnumerateInstanceLayerProperties");
		vkEnumeratePhysicalDevices = (PFN_vkEnumeratePhysicalDevices)_LoadProcedure("libvulkan.so", "vkEnumeratePhysicalDevices");
		// device
		vkGetPhysicalDeviceProperties = (PFN_vkGetPhysicalDeviceProperties)_LoadProcedure("libvulkan.so", "vkGetPhysicalDeviceProperties");
		vkGetPhysicalDeviceQueueFamilyProperties = (PFN_vkGetPhysicalDeviceQueueFamilyProperties)_LoadProcedure("libvulkan.so", "vkGetPhysicalDeviceQueueFamilyProperties");
		vkGetPhysicalDeviceFeatures = (PFN_vkGetPhysicalDeviceFeatures)_LoadProcedure("libvulkan.so", "vkGetPhysicalDeviceFeatures");
		vkCreateDevice = (PFN_vkCreateDevice)_LoadProcedure("libvulkan.so", "vkCreateDevice");
		vkEnumerateDeviceExtensionProperties = (PFN_vkEnumerateDeviceExtensionProperties)_LoadProcedure("libvulkan.so", "vkEnumerateDeviceExtensionProperties");
		vkGetPhysicalDeviceSurfaceSupportKHR = (PFN_vkGetPhysicalDeviceSurfaceSupportKHR)_LoadProcedure("libvulkan.so", "vkGetPhysicalDeviceSurfaceSupportKHR");
		vkCreateSwapchainKHR = (PFN_vkCreateSwapchainKHR)_LoadProcedure("libvulkan.so", "vkCreateSwapchainKHR");
		vkGetPhysicalDeviceSurfaceCapabilitiesKHR = (PFN_vkGetPhysicalDeviceSurfaceCapabilitiesKHR)_LoadProcedure("libvulkan.so", "vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
		vkGetPhysicalDeviceSurfaceFormatsKHR = (PFN_vkGetPhysicalDeviceSurfaceFormatsKHR)_LoadProcedure("libvulkan.so", "vkGetPhysicalDeviceSurfaceFormatsKHR");
		vkGetPhysicalDeviceSurfacePresentModesKHR = (PFN_vkGetPhysicalDeviceSurfacePresentModesKHR)_LoadProcedure("libvulkan.so", "vkGetPhysicalDeviceSurfacePresentModesKHR");
		vkCreateShaderModule = (PFN_vkCreateShaderModule)_LoadProcedure("libvulkan.so", "vkCreateShaderModule");
		vkCreatePipelineCache = (PFN_vkCreatePipelineCache)_LoadProcedure("libvulkan.so", "vkCreatePipelineCache");
		vkCreateGraphicsPipelines = (PFN_vkCreateGraphicsPipelines)_LoadProcedure("libvulkan.so", "vkCreateGraphicsPipelines");
		vkBeginCommandBuffer = (PFN_vkBeginCommandBuffer)_LoadProcedure("libvulkan.so", "vkBeginCommandBuffer");
		vkCmdBindPipeline = (PFN_vkCmdBindPipeline)_LoadProcedure("libvulkan.so", "vkCmdBindPipeline");
		vkCmdDraw = (PFN_vkCmdDraw)_LoadProcedure("libvulkan.so", "vkCmdDraw");
		vkQueuePresentKHR = (PFN_vkQueuePresentKHR)_LoadProcedure("libvulkan.so", "vkQueuePresentKHR");
		vkEndCommandBuffer = (PFN_vkEndCommandBuffer)_LoadProcedure("libvulkan.so", "vkEndCommandBuffer");
		vkCreatePipelineLayout = (PFN_vkCreatePipelineLayout)_LoadProcedure("libvulkan.so", "vkCreatePipelineLayout");
		vkCreateRenderPass = (PFN_vkCreateRenderPass)_LoadProcedure("libvulkan.so", "vkCreateRenderPass");
		vkCreateCommandPool = (PFN_vkCreateCommandPool)_LoadProcedure("libvulkan.so", "vkCreateCommandPool");
		vkAllocateCommandBuffers = (PFN_vkAllocateCommandBuffers)_LoadProcedure("libvulkan.so", "vkAllocateCommandBuffers");
		vkCmdBeginRenderPass = (PFN_vkCmdBeginRenderPass)_LoadProcedure("libvulkan.so", "vkCmdBeginRenderPass");
		vkCreateFramebuffer = (PFN_vkCreateFramebuffer)_LoadProcedure("libvulkan.so", "vkCreateFramebuffer");
		vkCreateImageView = (PFN_vkCreateImageView)_LoadProcedure("libvulkan.so", "vkCreateImageView");
		vkCreateImage = (PFN_vkCreateImage)_LoadProcedure("libvulkan.so", "vkCreateImage");
		vkGetSwapchainImagesKHR = (PFN_vkGetSwapchainImagesKHR)_LoadProcedure("libvulkan.so", "vkGetSwapchainImagesKHR");
		vkCmdEndRenderPass = (PFN_vkCmdEndRenderPass)_LoadProcedure("libvulkan.so", "vkCmdEndRenderPass");
		vkQueueSubmit = (PFN_vkQueueSubmit)_LoadProcedure("libvulkan.so", "vkQueueSubmit");
		vkCreateFence = (PFN_vkCreateFence)_LoadProcedure("libvulkan.so", "vkCreateFence");
		vkDestroyFence = (PFN_vkDestroyFence)_LoadProcedure("libvulkan.so", "vkDestroyFence");
		vkWaitForFences = (PFN_vkWaitForFences)_LoadProcedure("libvulkan.so", "vkWaitForFences");
		vkGetDeviceQueue = (PFN_vkGetDeviceQueue)_LoadProcedure("libvulkan.so", "vkGetDeviceQueue");
		vkResetFences = (PFN_vkResetFences)_LoadProcedure("libvulkan.so", "vkResetFences");
		vkCreateSemaphore = (PFN_vkCreateSemaphore)_LoadProcedure("libvulkan.so", "vkCreateSemaphore");
		vkAcquireNextImageKHR = (PFN_vkAcquireNextImageKHR)_LoadProcedure("libvulkan.so", "vkAcquireNextImageKHR");
		vkResetCommandBuffer = (PFN_vkResetCommandBuffer)_LoadProcedure("libvulkan.so", "vkResetCommandBuffer");
		vkCmdSetScissor = (PFN_vkCmdSetScissor)_LoadProcedure("libvulkan.so", "vkCmdSetScissor");
		...
		vkEnumerateInstanceExtensionProperties = (PFN_vkEnumerateInstanceExtensionProperties)_LoadProcedure("libvulkan.so", "vkEnumerateInstanceExtensionProperties");
...
#pragma region "shaders"
		...
		VkShaderModule fragModule;
		{
			...
			file_content fragShader = ReadFile("frag.spv");
		...
		VkShaderModule vertModule;
		{
			VkShaderModuleCreateInfo moduleInfo = {};
			moduleInfo.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
			file_content vertShader = ReadFile("vert.spv");
